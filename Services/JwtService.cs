...
public class JwtService : IJwtService
{
    ...
    public JwtService(IOptionsMonitor<JwtConfig> jwtConfig, ApiDbContext context, TokenValidationParameters tokenValidationParameters,  UserManager<IdentityUser> userManager)
    {
